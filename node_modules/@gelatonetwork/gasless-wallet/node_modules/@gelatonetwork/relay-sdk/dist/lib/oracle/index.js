...
const isOracleActive = (chainId) => __awaiter(void 0, void 0, void 0, function* () {
    const oracles = yield (0, exports.getGelatoOracles)();
...
const getGelatoOracles = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return (yield axios_1.default.get(`${constants_1.GELATO_RELAY_URL}/oracles/`)).data.oracles;
    }
    catch (error) {
...
const getPaymentTokens = (chainId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return (yield axios_1.default.get(`${constants_1.GELATO_RELAY_URL}/oracles/${chainId}/paymentTokens/`)).data.paymentTokens;
    }
    catch (error) {
...
const getEstimatedFee = (chainId, paymentToken, gasLimit, isHighPriority, gasLimitL1 = ethers_1.BigNumber.from(0)) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const res = yield axios_1.default.get(`${constants_1.GELATO_RELAY_URL}/oracles/${chainId}/estimate`, {
            params,
        });
