...
exports.getMultiCallContractAddress = void 0;
const getMultiCallContractAddress = (chainId) => {
    switch (chainId) {
        case 1:
        ...
        case 421613:
            return "0xCf8EDB3333Fae73b23f689229F4De6Ac95d1f707";
        default:
            throw new Error(`MultiCall Contract is not available on chainId[${chainId}]`);
    }
};
exports.getMultiCallContractAddress = getMultiCallContractAddress;
