...
import type { GnosisSafeProxyFactory, GnosisSafeProxyFactoryInterface } from "../GnosisSafeProxyFactory";
export declare class GnosisSafeProxyFactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): GnosisSafeProxyFactory;
}
